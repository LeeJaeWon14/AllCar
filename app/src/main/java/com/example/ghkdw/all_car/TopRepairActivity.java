...
public class TopRepairActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_repair);

        code = getIntent().getStringExtra("code");

        final ViewPager viewPager = (ViewPager)findViewById(R.id.viewPage_top_repair);
        adapterViewPager = new TopRepairActivity.MyPagerAdapter(getSupportFragmentManager());
        viewPager.setAdapter(adapterViewPager);

        CircleIndicator indicator = (CircleIndicator)findViewById(R.id.indicator_top_repair);
        indicator.setViewPager(viewPager);

        Button repairRecord = (Button)findViewById(R.id.repairBtn_top_repair);
        repairRecord.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final View dialogView = (View)View.inflate(TopRepairActivity.this, R.layout.prev_repair_dialog_layout, null);
                AlertDialog.Builder builder = new AlertDialog.Builder(TopRepairActivity.this);
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                        switch(rdoGroup.getCheckedRadioButtonId()) {
                            case R.id.rdoEngine:
                                ...
                                ArrayAdapter<String> engineAdapter = new ArrayAdapter<String>(TopRepairActivity.this, android.R.layout.simple_list_item_1, engineItems);
                            ...
                            case R.id.rdoFront:
                                ...
                                ArrayAdapter<String> frontAdapter = new ArrayAdapter<String>(TopRepairActivity.this, android.R.layout.simple_list_item_1, frontItems);
                            ...
                            case R.id.rdoBottom:
                                ...
                                ArrayAdapter<String> bottomAdapter = new ArrayAdapter<String>(TopRepairActivity.this, android.R.layout.simple_list_item_1, bottomItems);
                            ...
                            case R.id.rdoSus:
                                ...
                                ArrayAdapter<String> susAdapter = new ArrayAdapter<String>(TopRepairActivity.this, android.R.layout.simple_list_item_1, susItems);
                                ...
                                break;
                            default:
                                Toast.makeText(TopRepairActivity.this, "개발중", Toast.LENGTH_SHORT).show();
                                break;
                        }
                    }
                });
                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(viewParts.getVisibility() == View.INVISIBLE) {
                            Toast.makeText(TopRepairActivity.this, "부품을 먼저 선택해주세요!", Toast.LENGTH_SHORT).show();
                            return ;
                        }
                        ...
                        if(inputValue.getText().toString().equals("")) {
                            Toast.makeText(TopRepairActivity.this, "거리나 시간을 입력해주세요!", Toast.LENGTH_SHORT).show();
                            return ;
                        }
                        if(saveRecord(code, viewParts.getText().toString(), s_inputValue))
                            Toast.makeText(TopRepairActivity.this, "저장되었습니다", Toast.LENGTH_SHORT).show();
                        else
                            Toast.makeText(TopRepairActivity.this, "저장이 실패하였습니다", Toast.LENGTH_SHORT).show();
                        dlg.dismiss();
                    }
                });
    ...
    public static class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position) {
                case 0:
                    return EngineFragment.newInstance(0, "Page # 1", code);
                case 1:
                    return FrontFragment.newInstance(1, "Page # 2", code);
                default:
                    return null;
            }
        }
    ...
    public void showLoad() {
        final View dialogView = (View)View.inflate(TopRepairActivity.this, R.layout.only_ok_or_cancel_dialog, null);
        AlertDialog.Builder builder = new AlertDialog.Builder(TopRepairActivity.this);
        final AlertDialog dlg = builder.create();
